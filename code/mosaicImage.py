...
def mosaicImage(img):
    ...
    mos_img[1:image_height:2, 1:image_width:2] = img[1:image_height:2, 1:image_width:2, 0]
    #Blue channel (odds rows and columns)
    mos_img[0:image_height:2, 0:image_width:2] = img[0:image_height:2, 0:image_width:2, 2]
